package uk.ac.aber.lsweeney.externalcode;
 ...
 *
 * This class is a slightly adapted version of code that can be found here:
 * https://berry120.blogspot.com/2014/01/draggable-and-detachable-tabs-in-javafx.html
 *
 * In addition to the code found there, extra code has been added to make all tab stages undecorated and draggable.
 */
public class DraggableTab extends Tab {
    ...
    public DraggableTab(String text) {
        ...
        detachable = true;
        dragStage = new Stage();
        dragStage.initStyle(StageStyle.UTILITY);
            ...
            public void handle(MouseEvent t) {
                ...
                if (!t.isStillSincePress()) {
                    ...
                    EventHandler<WindowEvent> windowEventEventHandler = windowEvent -> {
                        for (TabPane t12 : tabPanes) {
                            t12.getSelectionModel().clearSelection();
                        }
                    };
                    newStage.setOnCloseRequest(windowEventEventHandler);
                    pane.requestLayout();
                    pane.requestFocus();
                }
            }
